...
public class LocomotiveGroupTest extends BaseTest {
    ...
    public void testJenkinsUserId() {
        final String userId = "Jenkins User ID: michaerublev";

        getDriver().findElement(By.xpath("//*[@id='tasks']/div[2]/span/a")).click();

        getDriver().findElement(By.xpath("//*[@id='person-michaerublev']/td[2]/a")).click();

        WebElement checkUserProfile = getDriver().findElement(By.xpath("//*[@id='main-panel']/div[2]"));

        String checkingInsideTheUser = checkUserProfile.getText();
        Assert.assertEquals(checkingInsideTheUser, userId);
    }
}
